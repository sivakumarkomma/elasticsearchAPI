...
public class BulkDeleteAPI {
  ...
  public static void main(String args[]) throws IOException {
    ...
    InputStream inputStream = BulkDeleteAPI.class.getResourceAsStream(FILE_NAME);
    ...
    Arrays.asList(array).forEach(documentDto ->
    {
      try {
        ...
        request.add(new DeleteRequest(INDEX_NAME, TYPE, preparePathBasedID(documentDto.getId())));
